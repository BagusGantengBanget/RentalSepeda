                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                       ...
                       {{--  <div class="form-group row">
                        ...
                        <div class="form-group row{{ $errors->has('gender') ? 'has-errors' : null}}">
                            <label for="gender" class="col-md-4 col-form-label text-md-right">{{ __('Gender') }}</label>
                            
                            <div class="col-md-6">
                                <select name="gender" id="" class="form-control">
                                    <option value="" hidden selected>---Pilih Kelamin---</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text-area" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="address" autofocus>
