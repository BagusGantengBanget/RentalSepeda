...
<head>
    ...
    <title>@yield('title') | Rental Sepeda</title>
    <!-- chartist CSS -->
                    ...
                    <ul id="sidebarnav">
                        ...
                        @if (auth()->user()->level == "admin")
                            ...
                            <ul aria-expanded="false" class="collapse  first-level in">
                                ...
                                <li class="sidebar-item">
                                    <a href="/merks" class="sidebar-link">
                                        <i class="mdi mdi-adjust"></i>
                                        <span class="hide-menu"> Data Merk </span>
                                    </a>
                                </li>
                                @endif
                                @if (auth()->user()->level == "admin")
                                <li class="sidebar-item">
                                    <a href="/bikes" class="sidebar-link">
                                        <i class="mdi mdi-adjust"></i>
                                        <span class="hide-menu"> Data Sepeda </span>
                                    </a>
                                </li>
                                @endif
                                @if (auth()->user()->level == "admin")
                            ...
                            <ul aria-expanded="false" class="collapse  first-level in">
                                ...
                                <li class="sidebar-item">
                                    <a href="/bookings" class="sidebar-link">
                                        <i class="mdi mdi-adjust"></i>
                                        <span class="hide-menu"> Daftar Sepeda </span>
                                    </a>
                                </li>
                                @endif
                                @if (auth()->user()->level == "admin")
                                <li class="sidebar-item">
                                    <a href="/confirms" class="sidebar-link">
                                        <i class="mdi mdi-adjust"></i>
                       ...
                       <li class="sidebar-item selected">
                            ...
                            <ul aria-expanded="false" class="collapse first-level in">
                                @if (auth()->user()->level == "admin")
                                <li class="sidebar-item">
                                    <a href="/transactionAdmin" class="sidebar-link">
                                        <i class="mdi mdi-adjust"></i>
