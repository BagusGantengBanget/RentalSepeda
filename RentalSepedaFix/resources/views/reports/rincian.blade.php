...
@section('title')
    Informasi Rincian Transaksi
@endsection 
@section('content')
    <div class="card material-card">
        <div class="card-body">
            <h4>Informasi Rincian Transaksi | <strong>{{$booking->booking_code}}</strong></h4>
            <p class="card-subtitle">Ini adalah data informasi rincian transaksi sepeda dengan kode booking <strong>{{$booking->booking_code}}</strong></p>
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <th>Rp. {{$booking->total_price}}</th>
                            </tr>
                            <tr>
                                <td>
                                    <input type="button" class="btn btn-danger float-left" value="Kembali" onclick="history.back(-1)" />
                                </td>
                                <td></td>
                                <th></th>
                            </tr>
